...
if __name__ == '__main__':
    ...
    # Da Datenpunkte im Minusbereich liegen, sind die Achsenwerte etwas verschoben.
    # X-Achse startet bei -23 und endet bei 135.
    # Y-Achse startet bei -27 und endet bei 145.
    # Damit die Punkte nicht auf den Linien der Achsen gezeigt werden.
    # Siehe Bild GaussianNB_data_neural_network_with_classification_with_axes_values_new.PNG
    ...
    print(classification) # [1 0 0 ... 0 0 1]
    ...
    print("Daten für CSV: ", select_for_csv) # Daten für CSV:  [ 1. 64. 69.]

    # Dataframe Inhalte angeben und danach ausgeben
    df = pd.DataFrame(select_for_csv)
    print("DataFrame: ", df)     # 0  1.0   64.0  69.0
