...
if __name__ == '__main__':
    ...
    print("Features: ", X) # Features:  [64. 69. 0.] usw.
    ...
    print("x_min:" , x_min) # x_min: -23
    print("y_min:" , y_min) # y_min: -27
    print("z_min:" , z_min) # z_min: -8
    # -8 bei z da es dort keine Minuswerte gibt
    ...
    # Accuracy: 0.9056666666666666 mit Farbe
    # Accuracy: 0.907 ohne Farbe (von predicted_G_ohne_Farbe.py)
    ...
    # Hierfür GaussianNB_color_data_neural_network_with_classification_new.PNG mit GaussianNB_data_neural_network_with_classification_new.PNG vergleichen

    print("Balanced accuracy:" , metrics.balanced_accuracy_score(y,classification))
    # Balanced accuracy: 0.9056666666666667
