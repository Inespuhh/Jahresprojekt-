...
if __name__ == '__main__':
    ...
    loc = "./predicted_test_result_new.xlsx" # Datei vom neuronalen Netz
    ...
    # print("Features: ", X) # Features:  [64. 69.] usw.
 
    # ValueError: Negative values in data passed to MultinomialNB (input X)
    # Die Minuswerte werden auf 0 gesetzt
    X[X < 0] = 0
    print("X Werte positiv: ", X)
    ...
    print("x_min:" , x_min) # x_min: -8
    print("y_min:" , y_min) # y_min: -8
    # Hier kommt -8 so wie erwartet, da es keine Minuswerte gibt
    ...
    mnb = MultinomialNB( alpha = 0.01, class_prior = class_prior_vec, fit_prior = True )
    # Hat keine Verbesserung/ Veränderung gebracht mit alpha = 0.01
    # Erhöhung vom alpha Wert bringt keine Veränderung
    # class_prior ist die Prioritätswahrscheinlichkeiten der Klassen. 
    # Falls angegeben, werden die Prioren nicht entsprechend den Daten angepasst.
    # alpha ist ein Glättungsparameter Additiv (Laplace/Lidstone) (0 für keine Glättung).
    # fit_prior sagt aus ob man Klassenvorwahrscheinlichkeiten lernen soll oder nicht. 
    # Falls false, wird ein einheitliches Prior verwendet.
    ...
    print("parameters:" , mnb.get_params()) # {'alpha': 0.01, 'fit_prior': True, 'class_prior': [0.3333333333333333, 0.3333333333333333, 0.3333333333333333]}
    ...
    print(classification) # [1 2 2 ... 2 2 1]
    ...
    # Balanced accuracy: 0.4073333333333333
...
def gen_plot():    
    ...
    ax.set_title('sklearn decision boundary MultinomialNB')
...
summary_op = tf.summary.image("MultinomialNB with data from the neural network", image)
