...
if __name__ == '__main__':
    ...
    # X-Achse startet bei -49 und endet bei 139.
    # Y-Achse startet bei -19 und endet bei 140.
    # Damit die Punkte nicht auf den Linien der Achsen gezeigt werden.
    # Siehe Bild GaussianNB_data_neural_network_with_classification_with_axes_values
