...
if __name__ == '__main__':
    ...
    print("x_min:" , x_min) # x_min: -23.0
    print("y_min:" , y_min) # y_min: -27.0
    ...
    bnb = BernoulliNB(alpha= 0.1, binarize = 64.0, class_prior = class_prior_vec, fit_prior = True)
    # Binarize da es sich um die Bernoulli Verteilung handelt
    # Schwellenwert für die Binarisierung (Abbildung auf Booleans) von Beispielmerkmalen. 
    # Wenn keine, wird angenommen, dass die Eingabe bereits aus binären Vektoren besteht.
